                ...
                <div class="card">
                  ...
                  <div class="card-body table-responsive p-0">
                    <div class="input-group mb-3">
                      ...
                      <input style="width: 850px" type="text" class="form-control" id="nome" value="{{ old('nome', $solicitante->nome) }}"  name="nome" placeholder="informe o nome do solicitante aqui" required>       
        </div>
