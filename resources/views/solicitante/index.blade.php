    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item">
        ...
        <div class="navbar-search-block">
          <form class="form-inline" action="{{ route('solicitante.index') }}">
  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0"><b>Gráfica - Solicitantes - Listagem</b></h5>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item">
                <a href="{{ route('login.logout') }}" class="btn btn-outline-primary"><i class="fas fa-unlock"></i></a> 
                <a href="{{ route('solicitante.create') }}" class="btn btn-outline-dark" >Novo solicitante</a>
              </li>
            </ol>
          </div>
        </div>
              ...
              <div class="card-header border-0">
                <div class="d-flex justify-content-between">
                  ...
                  <form>
                    <div class="row">
                      <div class="col-md-12">
                          <form action="{{ route('solicitante.index') }}">
                              <div class="input-group">
                                  <input type="search" name="parametro" id="parametro" value="{{ $parametro }}"class="form-control" placeholder="pesquisar solicitante">
                                  <div class="input-group-append">
