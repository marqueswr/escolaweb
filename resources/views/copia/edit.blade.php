  ...
  <div class="content-wrapper">
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h5 class="m-0"><b>Gráfica - Cópias - Alterar</b></h5>
          </div>
          <div class="col-sm-6">
    ...
    <div class="row">
		<div class="col-md-12">
			...
			<div class="card-header">
 				<form action="{{ route('copia.update',['copia'=>$copia]) }}" method="POST">
                    		@csrf
                        @method('PUT')
                    		<x-alert />
			</div>
...
<div class="row">
  <div class="col-md-6">
    <select  id="setores_id" name="setores_id" class="form-control">
...
<div class="row">
  <div class="col-md-6">
    <div class="input-group-prepend">
      ...
      <input style="width: 850px" type="number" class="form-control" id="quantidade" value="{{ old('quantidade', $copia->quantidade) }}"  name="quantidade" placeholder="informe a quantidade" >       
    </div>
  </div>
  ...
  <div class="col-md-6">
    <div class="input-group-prepend">
      ...
      <input style="width: 850px" type="date" class="form-control" id="dtasolicitacao"  value="{{ old('dtasolicitacao', $copia->dtasolicitacao) }}" name="dtasolicitacao" >       
    </div>
  </div>
</div>
 ...
 <a href="{{ route('copia.index') }}" class="btn btn-outline-dark" >CANCELAR</a>
  </p>
 </form>
</div>
		</div>
